...
4. The app is now available on localhost port 8080 as per default - navigate there in your browser (paste localhost:8080 into your browser's url bar)
...
note: CSS and JavaScript code is not original work (AI generated). This project is usefull for assessing Java Spring Boot (+limited HTML) capabilities
